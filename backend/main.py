...
app = FastAPI(
    title="KB OpenAPI Sample",
    description="KB OpenAPI sample backend",
    version="1.0.0",
...
if __name__ == "__main__":
    ...
    print("=" * 50)
    print(" KB OpenAPI Sample server starting")
    print("=" * 50)
